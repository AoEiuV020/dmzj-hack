.class public Lcz/msebera/android/httpclient/client/f/d;
...
.method public static a(Ljava/net/URI;)Ljava/net/URI;
    ...
    invoke-direct {v0, p0}, Lcz/msebera/android/httpclient/client/f/c;-><init>(Ljava/net/URI;)V

    invoke-virtual {v0}, Lcz/msebera/android/httpclient/client/f/c;->c()Ljava/lang/String;

    move-result-object v1

    if-eqz v1, :cond_1

    invoke-virtual {v0, v3}, Lcz/msebera/android/httpclient/client/f/c;->b(Ljava/lang/String;)Lcz/msebera/android/httpclient/client/f/c;
    ...
    :cond_3
    invoke-virtual {v0, v3}, Lcz/msebera/android/httpclient/client/f/c;->e(Ljava/lang/String;)Lcz/msebera/android/httpclient/client/f/c;
...
.method public static a(Ljava/net/URI;Lcz/msebera/android/httpclient/l;Z)Ljava/net/URI;
    .locals 3
    ...
    invoke-virtual {v0, v1}, Lcz/msebera/android/httpclient/client/f/c;->a(Ljava/lang/String;)Lcz/msebera/android/httpclient/client/f/c;
    ...
    invoke-virtual {v0, v1}, Lcz/msebera/android/httpclient/client/f/c;->a(I)Lcz/msebera/android/httpclient/client/f/c;

    :goto_1
    if-eqz p2, :cond_1

    invoke-virtual {v0, v2}, Lcz/msebera/android/httpclient/client/f/c;->e(Ljava/lang/String;)Lcz/msebera/android/httpclient/client/f/c;
    ...
    :cond_3
    invoke-virtual {v0, v2}, Lcz/msebera/android/httpclient/client/f/c;->a(Ljava/lang/String;)Lcz/msebera/android/httpclient/client/f/c;

    invoke-virtual {v0, v2}, Lcz/msebera/android/httpclient/client/f/c;->c(Ljava/lang/String;)Lcz/msebera/android/httpclient/client/f/c;
...
.method public static a(Ljava/net/URI;Ljava/net/URI;)Ljava/net/URI;
    ...
    invoke-static {p0, p1}, Lcz/msebera/android/httpclient/client/f/d;->b(Ljava/net/URI;Ljava/net/URI;)Ljava/net/URI;
    ...
    :cond_2
    invoke-static {v0}, Lcz/msebera/android/httpclient/client/f/d;->c(Ljava/net/URI;)Ljava/net/URI;
...
.method public static b(Ljava/net/URI;)Lcz/msebera/android/httpclient/l;
    .locals 9
    ...
    :try_start_1
    new-instance v1, Lcz/msebera/android/httpclient/l;

    invoke-direct {v1, v0, v4, v2}, Lcz/msebera/android/httpclient/l;-><init>(Ljava/lang/String;ILjava/lang/String;)V
    :try_end_1
