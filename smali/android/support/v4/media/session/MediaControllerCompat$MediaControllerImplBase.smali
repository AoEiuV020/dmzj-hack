...
.method public constructor <init>(Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
    ...
    iput-object p1, p0, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplBase;->a:Landroid/support/v4/media/session/MediaSessionCompat$Token;
    ...
    iput-object v0, p0, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplBase;->b:Landroid/support/v4/media/session/IMediaSession;
...
.method public adjustVolume(II)V
    ...
    :try_start_0
    iget-object v0, p0, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplBase;->b:Landroid/support/v4/media/session/IMediaSession;
...
.method public getTransportControls()Landroid/support/v4/media/session/MediaControllerCompat$TransportControls;
    ...
    iget-object v0, p0, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplBase;->c:Landroid/support/v4/media/session/MediaControllerCompat$TransportControls;

    if-nez v0, :cond_0

    new-instance v0, Landroid/support/v4/media/session/MediaControllerCompat$TransportControlsBase;

    iget-object v1, p0, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplBase;->b:Landroid/support/v4/media/session/IMediaSession;
    ...
    iput-object v0, p0, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplBase;->c:Landroid/support/v4/media/session/MediaControllerCompat$TransportControls;
