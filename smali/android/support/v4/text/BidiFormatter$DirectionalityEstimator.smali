...
.method private e()B
    ...
    iget v0, p0, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->e:I
    ...
    iput-char v0, p0, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->f:C
...
.method private g()B
    ...
    iget v1, p0, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->d:I
...
.method a()I
    ...
    invoke-virtual {p0}, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->c()B
    ...
    invoke-virtual {p0}, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->d()B
...
.method c()B
    ...
    iget-char v0, p0, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->f:C
    ...
    invoke-static {v0}, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->a(C)B

    move-result v0

    iget-boolean v1, p0, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->c:Z
    ...
    invoke-direct {p0}, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->e()B
    ...
    invoke-direct {p0}, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->g()B
...
.method d()B
    ...
    invoke-direct {p0}, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->f()B
    ...
    invoke-direct {p0}, Landroid/support/v4/text/BidiFormatter$DirectionalityEstimator;->h()B
