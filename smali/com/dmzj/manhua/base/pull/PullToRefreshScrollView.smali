.class public Lcom/dmzj/manhua/base/pull/PullToRefreshScrollView;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/dmzj/manhua/base/pull/PullToRefreshScrollView$a;
    }
.end annotation
...
.method protected synthetic a(Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    invoke-virtual {p0, p1, p2}, Lcom/dmzj/manhua/base/pull/PullToRefreshScrollView;->b(Landroid/content/Context;Landroid/util/AttributeSet;)Lcom/dmzj/manhua/base/pull/ScrollListenScrollView;
...
.method protected b(Landroid/content/Context;Landroid/util/AttributeSet;)Lcom/dmzj/manhua/base/pull/ScrollListenScrollView;
    .locals 2
    ...
    new-instance v0, Lcom/dmzj/manhua/base/pull/PullToRefreshScrollView$a;

    invoke-direct {v0, p0, p1, p2}, Lcom/dmzj/manhua/base/pull/PullToRefreshScrollView$a;-><init>(Lcom/dmzj/manhua/base/pull/PullToRefreshScrollView;Landroid/content/Context;Landroid/util/AttributeSet;)V

    :goto_0
    const v1, 0x7f0c002a

    invoke-virtual {v0, v1}, Lcom/dmzj/manhua/base/pull/ScrollListenScrollView;->setId(I)V

    return-object v0

    :cond_0
    new-instance v0, Lcom/dmzj/manhua/base/pull/ScrollListenScrollView;

    invoke-direct {v0, p1, p2}, Lcom/dmzj/manhua/base/pull/ScrollListenScrollView;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method protected d()Z
    ...
    iget-object v0, p0, Lcom/dmzj/manhua/base/pull/PullToRefreshScrollView;->a:Landroid/view/View;

    check-cast v0, Lcom/dmzj/manhua/base/pull/ScrollListenScrollView;

    invoke-virtual {v0}, Lcom/dmzj/manhua/base/pull/ScrollListenScrollView;->getScrollY()I
...
.method protected e()Z
    ...
    invoke-virtual {v0, v1}, Lcom/dmzj/manhua/base/pull/ScrollListenScrollView;->getChildAt(I)Landroid/view/View;
    ...
    invoke-virtual {p0}, Lcom/dmzj/manhua/base/pull/PullToRefreshScrollView;->getHeight()I
